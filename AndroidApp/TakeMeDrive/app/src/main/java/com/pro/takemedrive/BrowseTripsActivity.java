...
public class BrowseTripsActivity extends AppCompatActivity {

    int user_id = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_browse_trips);
    ...
    private void LoadData() {
        ...
        Call<List<FullTrip>> call = api.get_all_trips(user_id);
            ...
            public void onResponse(Call<List<FullTrip>> call, Response<List<FullTrip>> response) {
                ...
                TripAdapter adapter = new TripAdapter(getBaseContext(), new TripAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(FullTrip item) {
                        ...
                        Intent i = new Intent(getBaseContext(),TheTrip.class);
                        i.putExtra("trip_id",item.getId());
                        i.putExtra("driver",item.getDriver());
